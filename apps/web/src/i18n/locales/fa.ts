...
export const fa: Dict = {
  ...
  'pet.railCollapse': 'مخفی کردن انتخابگر',
  ...
  'pet.atlasPickerHint': 'پت‌های Codex با ۹ حالت انیمیشن می‌آیند. حلقهٔ مورد نظر را انتخاب کنید تا در یک نوار برش بخورد.',
  'pet.atlasCancel': 'حذف اطلس',
  'pet.atlasAdopt': 'از این ردیف استفاده کن',
