...
export const ru: Dict = {
  ...
  'pet.atlasPickerHint': 'У Codex-петов 9 рядов анимаций. Выберите нужный цикл — мы вырежем его в полоску.',
  'pet.atlasCancel': 'Отменить атлас',
  'pet.atlasAdopt': 'Использовать этот ряд',
