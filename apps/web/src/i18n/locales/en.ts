...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to viaim Design Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to viaim Design Cloud & retry',
  'chat.amrError.authMessage': 'Your viaim Design Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your viaim Design Cloud balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with viaim Design Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the viaim Design Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The viaim Design Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the viaim Design Cloud agent — steadier and better value.',
  ...
  'settings.welcomeTitle': 'Welcome to viaim Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. viaim Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. viaim Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to viaim Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to viaim Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to viaim Design Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the viaim Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to viaim Design.',
  ...
  'settings.amrAccountStatus': 'viaim Design Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose viaim Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the viaim Design team',
  'settings.privacyConsentKicker': 'Help us improve viaim Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how viaim Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  'settings.updateQuitFailed': 'The installer opened, but viaim Design could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your viaim Design projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure viaim Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in viaim Design, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'viaim Design must be running for MCP tool calls to succeed. If you started your coding agent before opening viaim Design, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the viaim Design Discord',
  'entry.discordAriaWithOnline': 'Join the viaim Design Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow viaim Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow viaim Design on Xiaohongshu',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable viaim Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit viaim Design Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local viaim Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. viaim Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use viaim Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with viaim Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to viaim Design',
  'pluginCard.contributeTitle': 'Contribute plugin to viaim Design with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use viaim Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure viaim Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use viaim Design everywhere',
  'useEverywhere.modalTitle': 'Use viaim Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop viaim Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'viaim Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'viaim Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires viaim Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without viaim Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive viaim Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose viaim Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'viaim Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover viaim Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the viaim Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without viaim Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). viaim Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside viaim Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + viaim Design extras)',
  ...
  'entry.githubStarAria': 'Star viaim Design on GitHub',
  ...
  'newproj.locationDefault': 'viaim Design projects',
  ...
  'avatar.amrConsole': 'viaim Design Cloud',
  ...
  'socialShare.openDesignSection': 'Share viaim Design',
  'socialShare.openDesignTitle': 'viaim Design on GitHub',
  'socialShare.openDesignText': 'viaim Design is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with viaim Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with viaim Design: {title}\n{url}\nviaim Design repo: {repo}',
  ...
  'brandEnrichment.body': "viaim Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask viaim Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want viaim Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure viaim Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying viaim Design? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to viaim Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow viaim Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow viaim Design on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to viaim Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with viaim Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with viaim Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple viaim Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'updater.availableBody': 'viaim Design {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. viaim Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit viaim Design',
  'updater.quitFailedBody': 'The installer is open, but viaim Design could not quit. Quit viaim Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. viaim Design will close and open the installer.',
  'updater.readyVersion': 'viaim Design {version} is ready. viaim Design will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach viaim Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions viaim Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach viaim Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'viaim Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
