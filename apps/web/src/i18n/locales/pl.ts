...
export const pl: Dict = {
  ...
  'pet.atlasPickerHint': 'Pety Codex mają 9 stanów animacji. Wybierz pętlę, którą chcesz, a my wytniemy ją w pasek.',
  'pet.atlasCancel': 'Odrzuć atlas',
  'pet.atlasAdopt': 'Użyj tego wiersza',
