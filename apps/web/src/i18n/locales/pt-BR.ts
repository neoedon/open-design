...
export const ptBR: Dict = {
  ...
  'pet.railCollapse': 'Esconder seletor',
  ...
  'pet.atlasPickerHint': 'Os pets do Codex trazem 9 estados de animação. Escolha o loop desejado que recortamos em uma tira.',
  'pet.atlasCancel': 'Descartar atlas',
  'pet.atlasAdopt': 'Usar esta linha',
