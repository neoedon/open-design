...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'viaim Design artifact';
...
- Keep generated product UI free of viaim Design chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or viaim Design chrome in the production UI.
