...
describe("@open-design/release", () => {
  ...
  it("centralizes release identity and namespace derivation", () => {
    expect(releaseChannelDescriptor("prerelease").productName).toBe("viaim Design Prerelease");
    expect(releaseChannelDescriptor("betas").productName).toBe("viaim Design Betas");
